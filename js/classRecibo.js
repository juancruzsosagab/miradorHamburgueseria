...
class reciboCliente{
    constructor(nombre,telefono, email, totalAPagar, nombreHamburguesas,transaccion){
    this.nombre = nombre;
    ...
    <div class="card text-center id="para-descargar">
      ...
      <div class="card-body">
        <h5 class="card-title">Mirador Hamburguesería</h5>
          <div class="card-text">
              <ol class="list-group">
                <li class="list-group-item">Estado de transacción: ${this.transaccion}</li>
        ...
        <br>
          <div class="d-grid gap-2 col-6 mx-auto">
              ...
              <button id="btnBuyAgain" class="btn btn-warning">Realizar otra compra</button>
          </div>
        </div> 
